...
import { Star, Heart, Share2, Truck, Shield, RefreshCw, Info, ChevronLeft, ChevronRight } from "lucide-react";
                    ...
                    {mockProducts
                        ...
                        .map((p) => (
                            <div key={p.id} className="group cursor-pointer">
                                <div className="aspect-square relative overflow-hidden rounded-lg bg-card border border-border mb-3">
                                    <Image
                                        src={p.images[0]}
                                        alt={p.name}
                                        fill
